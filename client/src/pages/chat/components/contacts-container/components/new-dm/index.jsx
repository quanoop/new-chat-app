                                        ...
                                        <div key={contact._id} className="flex gap-3 items-center cursor-pointer"
                                            ...
                                            <div className='w-12 h-12 relative'>
                                                <Avatar className='h-12 w-12 rounded-full overflow-hidden'>
                                                    {contact.image ? (<AvatarImage className='object-cover w-full h-full bg-black rounded-full' src={`${HOST}/${contact.image}`} alt='profile' />) : (<div className={`uppercase h-12 w-12 text-lg border-[1px] flex items-center justify-center rounded-full ${getColor(contact.getColor)}`}>
